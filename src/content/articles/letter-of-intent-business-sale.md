---
title: "The Letter of Intent (LOI) in a Business Sale: What to Negotiate"
description: "The LOI sets price, structure, and exclusivity — and is the moment leverage shifts to the buyer. Here's what to negotiate hard, what to defer, and what's non-negotiable."
pillar: how-to-sell
spoke: loi
publishDate: 2026-04-14
updatedDate: 2026-04-22
answer: "A Letter of Intent (LOI) is the non-binding term sheet that sets purchase price, deal structure, exclusivity, and the path to closing in a business sale. Although most provisions are non-binding, the LOI determines 80% of the final deal because re-trading after signing is hard. Sellers should negotiate the LOI as if it were binding — focus on price, payment structure (cash at close vs. seller note vs. earnout), working capital target, exclusivity length, and reps/warranties scope before signing."
faqs:
  - question: "Is a Letter of Intent legally binding?"
    answer: "Most LOI provisions are non-binding — price, structure, and timeline are subject to satisfactory diligence and definitive agreements. But certain provisions are binding: exclusivity (no-shop), confidentiality, expense allocation, and sometimes a break-up fee. Sellers must read the binding/non-binding language carefully because a non-binding LOI still locks them out of other buyers for 60–90 days."
  - question: "How long should the exclusivity period be?"
    answer: "30–60 days is reasonable for a well-prepared business; 90 days is common for SBA-financed deals; longer than 120 days is rarely justified. Always pair exclusivity with milestones — diligence kickoff within 7 days, financing commitment within 30 days, etc. — so a slow buyer can be shaken loose if they're not progressing."
  - question: "What's a typical earnout structure?"
    answer: "Earnouts tie 10–30% of purchase price to post-close performance — usually revenue or EBITDA targets over 1–3 years. Sellers should resist earnouts when possible because the buyer controls the operations being measured. If accepted, negotiate clear metrics, audit rights, protection against buyer manipulation (e.g., shifting expenses), and acceleration triggers (death, disability, sale of the business)."
  - question: "What's a working capital target and why does it matter?"
    answer: "The working capital target is a normalized level of accounts receivable, inventory, and accounts payable that the buyer expects on the closing balance sheet. If actual closing working capital is below the target, the buyer credits the difference against purchase price. Sellers often lose $50K–$500K to working capital adjustments they didn't understand at LOI signing. Negotiate the target carefully and define it precisely."
  - question: "Can I negotiate after signing the LOI?"
    answer: "Yes, but you've lost most of your leverage. The buyer has exclusivity, diligence is underway, and you're 60+ days from your next-best alternative. Re-trades almost always go in the buyer's favor. The right time to negotiate every material term is before signing — once signed, fight only on items that materially change due to actual diligence findings."
relatedArticles:
