---
title: "How to Increase Your Business Valuation Before Selling"
description: "The 12–24 months before listing are when valuation is made or lost. Six concrete levers that move your multiple, not just your earnings — and which to prioritize."
pillar: valuation
spoke: increasing-value
publishDate: 2026-04-19
updatedDate: 2026-04-25
answer: "Six levers move business valuation in the 12–24 months before sale: (1) reducing owner-dependence by hiring or elevating a GM, (2) diversifying customer concentration to no single customer over 15%, (3) increasing recurring revenue percentage, (4) raising prices and margins where you've been undercharging, (5) cleaning up books and producing a defensible add-back schedule, and (6) timing the sale after three years of stable or growing SDE. Owners who execute on 3+ of these typically sell for 30–60% more than owners who go to market reactively."
faqs:
  - question: "How much can I realistically increase my valuation in 12 months?"
    answer: "Most owners with a willing-to-execute mindset can move their multiple up by 0.5x in 12 months and 1.0x–1.5x in 24 months. On a business with $500K SDE, that's $250K–$750K in additional sale price from preparation alone. The biggest gains come from addressing owner-dependence and customer concentration — both take longer than 12 months for full effect."
  - question: "Should I invest in growth or in cleanup before selling?"
    answer: "Cleanup beats growth every time in the 12 months before listing. Buyers reward visible quality (clean books, low concentration, working GM) more than recent revenue spikes — which they discount as one-off. If you have 18+ months of runway, the order is: clean up first, then drive durable growth. Last-minute revenue from a single big customer often hurts your multiple."
  - question: "How do I raise prices without losing customers?"
    answer: "Most owners are 5–15% below the market price for their work and don't know it. Test by raising prices on new customers first. If conversion holds, raise on existing customers with 90 days notice and a small value-add (extended hours, new service tier, faster response). Customer churn from price increases is almost always lower than owners fear, and price changes flow 1:1 to the bottom line — multiplied by the multiple."
  - question: "What should I NOT do in the year before selling?"
    answer: "Don't make big capex investments — most don't pay back fast enough to show in TTM SDE. Don't launch new business lines that confuse the story. Don't take on customers that worsen concentration. Don't hire expensive senior talent unless you'll keep them post-sale. Don't take a long vacation that disrupts operations. The pre-sale year is for execution, not experimentation."
  - question: "When is it too late to prepare?"
    answer: "It's never too late, but the leverage of preparation drops fast as the listing date approaches. Six months out: financial cleanup, add-back schedule, and customer diversification can still happen. Three months out: only the lowest-effort items (cleanup, documentation, lease renewal). One month out: list as-is. The biggest gains require 18–24 months of runway."
relatedArticles:
  - what-is-sde-sellers-discretionary-earnings
  - business-valuation-multiples-by-industry
  - add-backs-business-valuation
...
- **Build the add-back schedule** as a documented spreadsheet — see [Add-backs in Business Valuation](/business-valuation/add-backs-business-valuation).
