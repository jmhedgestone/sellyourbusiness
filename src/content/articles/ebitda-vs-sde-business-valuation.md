---
title: "EBITDA vs SDE: Which One Applies to Your Business Sale?"
description: "EBITDA and SDE are not interchangeable — using the wrong one mis-prices your business by 40–80%. Here's exactly when each applies and how to translate between them."
pillar: valuation
spoke: ebitda-vs-sde
publishDate: 2026-04-17
updatedDate: 2026-04-25
answer: "SDE (Seller's Discretionary Earnings) includes the owner's salary as part of earnings; EBITDA does not. SDE is used for owner-operated businesses where one full-time owner is essential — typically under $1M in profit. EBITDA applies to businesses run by professional management or where the buyer would replace the owner with a hired CEO. Above roughly $1M in earnings or $5M in revenue, deals price on EBITDA. Using SDE on a business that should price on EBITDA overstates value by the cost of replacement management — usually $80K–$250K per year, multiplied by the multiple."
faqs:
  - question: "Where exactly is the cutoff between SDE and EBITDA?"
    answer: "There's no hard line, but the convention is: under $750K earnings, almost always SDE. Over $1.5M earnings, almost always EBITDA. Between $750K and $1.5M, both metrics get used and the buyer mix decides — individual buyers and SBA loans tend to use SDE; PE and strategic acquirers use EBITDA. Some brokers list at both."
  - question: "Why does the same business have a higher SDE than EBITDA?"
    answer: "SDE adds the owner's compensation back; EBITDA doesn't. If you draw $150K in salary plus $40K in benefits, your SDE is $190K higher than your EBITDA. That difference is real money to a small-business buyer who'll work in the business themselves, but irrelevant to a PE buyer who'll hire a $150K GM."
  - question: "Can I just translate SDE to EBITDA by subtracting my salary?"
    answer: "Roughly, yes, but use a market-rate manager salary instead of your actual draw. If you pay yourself $250K but a market-rate GM costs $130K, the EBITDA-equivalent earnings are SDE minus $130K — not minus $250K. The market salary is what the buyer will actually have to pay."
  - question: "Which metric do SBA lenders use?"
    answer: "SBA-financed deals (under $5M) use SDE because they assume an owner-operator buyer who will work in the business and pay themselves from earnings. The SBA's debt-service coverage requirement is calculated against SDE less owner draw — they want to confirm the buyer can pay debt service AND live on what's left."
  - question: "What if my business is somewhere between owner-operator and professionally managed?"
    answer: "This is the messiest middle. The fix: present both numbers in your CIM. Show SDE for individual / SBA buyers and adjusted EBITDA (SDE minus market manager salary) for PE buyers. Different buyer pools will value your business on different metrics — let them. The deal you ultimately accept will price on whichever metric the winning buyer uses."
relatedArticles:
...
1. Calculate your SDE — see [What is SDE](/business-valuation/what-is-sde-sellers-discretionary-earnings) for the full method.
2. Look up a market-rate GM salary in your industry and size range.
3. Calculate adjusted EBITDA = SDE − loaded market GM cost.
