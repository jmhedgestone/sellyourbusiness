---
title: "Add-Backs in Business Valuation: What's Legitimate, What's Not"
description: "Every defensible add-back puts dollar-for-dollar value on top of your sale price — multiplied by the multiple. Here's exactly what buyers will accept, what they'll reject, and what kills deals."
pillar: valuation
spoke: addbacks
publishDate: 2026-04-18
updatedDate: 2026-04-25
answer: "Add-backs are non-recurring, discretionary, or personal expenses removed from reported expenses to reveal true earning power (SDE or adjusted EBITDA). Legitimate add-backs include owner salary and benefits, family on payroll without real roles, personal vehicles, one-time legal or settlement costs, and major non-recurring projects. Buyers reject anything ongoing — marketing labeled 'one-time,' standard employee benefits, capex disguised as expense. Every add-back must be defensible with documentation; buyers verify in diligence."
faqs:
  - question: "How much can add-backs reasonably increase my SDE?"
    answer: "For most owner-operated businesses, add-backs increase reported net income by 30–80%. Owner compensation alone is typically the largest single add-back at $80K–$300K. Owner perks (vehicles, family members on payroll, personal travel) add another $10K–$50K for most businesses. One-time expenses vary widely. Add-backs above 100% of net income trigger heavy buyer scrutiny — make sure every line is documented."
  - question: "Will the buyer accept all my proposed add-backs?"
    answer: "No. In typical due diligence, buyers accept 70–90% of proposed add-backs and challenge the rest. Common rejections: marketing expenses called 'one-time campaigns,' equipment purchases that map to ongoing maintenance, employee bonuses called 'one-time' that paid in multiple years. Build your add-back schedule conservatively — over-claiming damages your credibility on legitimate items."
  - question: "Should I get a Quality of Earnings (QoE) report?"
    answer: "If your SDE is over $1M, almost always yes. A reputable QoE firm ($10K–$40K) independently verifies your add-backs and produces a report buyers and lenders trust. The cost typically pays for itself by preempting buyer price reductions in diligence. Below $1M SDE, a clean broker-prepared add-back schedule with strong documentation is usually sufficient."
  - question: "Can I add back my own discretionary spending?"
    answer: "Only what's clearly personal and runs through the business. A $200 lunch with a customer is a real business expense, even if it's at your favorite restaurant. The same lunch with your spouse is personal. The bright line: would the expense exist if the business were owned by an absentee buyer? If yes, it's a real expense. If no, it's an add-back."
  - question: "What's the worst add-back mistake owners make?"
    answer: "Adding back a recurring expense by labeling it 'one-time.' Buyers and QoE firms cross-check add-backs against historical patterns — if you 'one-time'd a marketing expense in three of the last five years, it's not one-time. This is the fastest way to lose buyer trust, which leads to broader skepticism about every other add-back you've claimed."
relatedArticles:
  - what-is-sde-sellers-discretionary-earnings
  - ebitda-vs-sde-business-valuation
...
Same items, but PE buyers replace the owner salary with a market manager salary instead of fully adding it back. See [EBITDA vs SDE](/business-valuation/ebitda-vs-sde-business-valuation) for the full mechanics.
...
5. Get a [free valuation](/valuation) to see what your add-backs translate to as a real-market sale price.
